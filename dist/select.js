 ...
 * Version: 0.14.2 - 2016-02-10T09:26:38.595Z
 * License: MIT
 */
...
uis.controller('uiSelectCtrl',
  ...
  ctrl.activate = function(initSearchValue, avoidReset) {
    if (!ctrl.disabled  && !ctrl.open) {
      ...
      if (ctrl.$animate && ctrl.$animate.enabled(container[0]) && ctrl.$animate.on) {
...
$templateCache.put("bootstrap/select-multiple.tpl.html","<div class=\"ui-select-container ui-select-multiple ui-select-bootstrap dropdown form-control\" ng-class=\"{open: $select.open}\"><div><div class=\"ui-select-match\"></div><input type=\"text\" autocomplete=\"false\" autocorrect=\"off\" autocapitalize=\"off\" spellcheck=\"false\" class=\"ui-select-search input-xs\" placeholder=\"{{$selectMultiple.getPlaceholder()}}\" ng-disabled=\"$select.disabled\" ng-hide=\"$select.disabled\" ng-click=\"$select.activate()\" ng-model=\"$select.search\" role=\"combobox\" aria-label=\"{{ $select.baseTitle }}\" ondrop=\"return false;\"></div><div class=\"ui-select-choices\"></div><button ng-click=\"$selectMultiple.selectAll()\" ng-if=\"$select.selectAll\" ng-disabled=\"$select.disabled\" class=\"btn btn-link btn-xs\">{{$select.selectAll}}</button> <button ng-click=\"$selectMultiple.clearAll()\" ng-if=\"$select.clearAll\" ng-disabled=\"$select.disabled\" class=\"btn btn-link btn-xs\">{{$select.clearAll}}</button></div>");
...
$templateCache.put("select2/select-multiple.tpl.html","<div class=\"ui-select-container ui-select-multiple select2 select2-container select2-container-multi\" ng-class=\"{\'select2-container-active select2-dropdown-open open\': $select.open, \'select2-container-disabled\': $select.disabled}\"><ul class=\"select2-choices\"><span class=\"ui-select-match\"></span><li class=\"select2-search-field\"><input type=\"text\" autocomplete=\"false\" autocorrect=\"off\" autocapitalize=\"off\" spellcheck=\"false\" role=\"combobox\" aria-expanded=\"true\" aria-owns=\"ui-select-choices-{{ $select.generatedId }}\" aria-label=\"{{ $select.baseTitle }}\" aria-activedescendant=\"ui-select-choices-row-{{ $select.generatedId }}-{{ $select.activeIndex }}\" class=\"select2-input ui-select-search\" placeholder=\"{{$selectMultiple.getPlaceholder()}}\" ng-disabled=\"$select.disabled\" ng-hide=\"$select.disabled\" ng-model=\"$select.search\" ng-click=\"$select.activate()\" style=\"width: 34px;\" ondrop=\"return false;\"></li></ul><div class=\"ui-select-dropdown select2-drop select2-with-searchbox select2-drop-active\" ng-class=\"{\'select2-display-none\': !$select.open}\"><div class=\"ui-select-choices\"></div></div><button ng-click=\"$selectMultiple.selectAll()\" ng-if=\"$select.selectAll\" ng-disabled=\"$select.disabled\">{{$select.selectAll}}</button> <button ng-click=\"$selectMultiple.clearAll()\" ng-if=\"$select.clearAll\" ng-disabled=\"$select.disabled\">{{$select.clearAll}}</button></div>");
